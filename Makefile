...
#$(NAME): $(SRCS) $(OBJS) $(HEADER) $(LIBFT)
#	@gcc $(CFLAGS) -lmlx -framework OpenGL -framework AppKit $(SRCS) $(LIBFT)  -o $@
#	@echo $@ ----------------- ready -----------------

#$(BONUS) : $(SRCS_BONUS) $(OBJS_BONUS) $(HEADER_BONUS) $(LIBFT_BONUS)
#	@gcc $(CFLAGS) -lmlx -framework OpenGL -framework AppKit $(SRC_BONUS) $(LIBFT_BONUS)  -o so_long_bonus
#	@echo $@ ----------------- ready -----------------
